    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        ...
        <div className="flex items-center justify-center gap-4 mb-8">
          ...
          <p className="font-display text-xl sm:text-2xl text-[var(--rose-light)]/80 tracking-[0.4em] uppercase">Unisex Salon</p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-14">
          <a href="https://wa.me/917011810776?text=Hi! I'd like to book an appointment at MAAN Unisex Salon" target="_blank" className="btn-primary px-10 py-4 rounded-full text-lg font-medium inline-flex items-center justify-center gap-3">
            <span>Book Appointment</span>
            <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2"><path d="M5 12h14M12 5l7 7-7 7" /></svg>
          </a>
          <a href="#services" className="btn-outline px-10 py-4 rounded-full text-lg font-medium inline-flex items-center justify-center">Explore Services</a>
        </div>
